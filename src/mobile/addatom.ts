...
export default class AddAtomMobile extends Actor {
	...
	public async do(): Promise<void> {
		...
		// 从码云拉取代码模板
		await this.shellexec('git pull git@github.com:mm-tpl/atom-mobile.git', cwd);
...
`;
	...
	private async update_pkg(folder: string, no: string, user: string, remote: string) {
		...
		pkg.scripts.up = 'git pull git@github.com:mm-tpl/atom-mobile.git master';
